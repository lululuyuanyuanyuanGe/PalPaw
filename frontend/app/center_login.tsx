...
export default function CenterLogin() {
    ...
    const register = async () => {
        setStatusMessage('');
        try{
            const result = await fetch(`http://localhost:8080/api/centers/login`, {
                method: "POST",
                headers: {
            ...
            return (
                <View style={styles.container}>
                    ...
                    <TouchableOpacity onPress={() => router.push('/center_register')}>
                        <Text style={styles.switchText}>Don't have an account yet? Register</Text>
                    </TouchableOpacity>
                </View>
            );
}
